...
import backgroundImage from './DARK.jpg';

function Foot()
{
  return (
      
      <div style={{ backgroundColor: '#c41e3a', color: '#000000', padding: '0px' }}>
           <div className="Home" style={{ backgroundImage: `url(${backgroundImage})`, backgroundSize: 'cover', backgroundPosition: 'center', minHeight: '5vh' }}>
