  ...
  return (
    ...
    <Card sx={{ width:"1500px"}}>
      ...
      <CardContent>
        ...
        Deliver Us Devil(2002)<br></br>
        R | 175 min | Horror, Drama<br></br>
    ...
    <Card sx={{ width:"1400px" }}>
      ...
      <CardContent>
      <Typography variant="body2" color="text.secondary">
      Infinity Pool (2014) <br></br>
        R | 175 min | Horror, Drama<br></br>

       9.1  Rate 99 Metascore<br></br>
    ...
    <Card sx={{ width:"1400px" }}>
      ...
      <CardContent>
      <Typography variant="body2" color="text.secondary">
     NightMare (2015)<br></br>
       9.0  Rate 96 Metascore<br></br>
    ...
    <Card sx={{ width:"1400px" }}>
      ...
      <CardContent>
      <Typography variant="body2" color="text.secondary">
      Drag Me To Hell(2013) <br></br>
      PG | 107 min | Horror, Adventure<br></br>

       10.0 Rate 100 Metascore<br></br>
    ...
    <Card sx={{ width:"1500px"}}>
      ...
      <CardContent>
      <Typography variant="body2" color="text.secondary">
      The popes Exorcist(2020) <br></br>
        R | 175 min | Crime, Horror<br></br>
    ...
    <Card sx={{ width:"1400px" }}>
      ...
      <CardContent>
      <Typography variant="body2" color="text.secondary">
      Wrong Turn(2017)<br></br>
      PG | 96 min | Horror, Adventure, <br></br>
    ...
    <Card sx={{ width:"1400px" }}>
      ...
      <CardContent>
      <Typography variant="body2" color="text.secondary">
      The Conjuring (2003)<br></br>
      PG-13 | 144 min | Action, Horror, Thriller<br></br>
    ...
    <Card sx={{ width:"1500px"}}>
      ...
      <CardContent>
      <Typography variant="body2" color="text.secondary">
      Talk To Me(2013) <br></br>
        R | 175 min |Horror, Crime, Drama<br></br>
    ...
    <Card sx={{ width:"1400px" }}>
      ...
      <Typography variant="body2" color="text.secondary">
      The NUN(2018)<br></br>
        R | 175 min | Crime, Drama,Horror<br></br>
